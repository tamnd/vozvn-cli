...
Most of these come down to network reality or how vozvn serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vozvn rate-limits like any public site. vozvn already paces
...
Where a surface is gated, vozvn reads a cookie or token you supply
...
`vozvn`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vozvn actually did
